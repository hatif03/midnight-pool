const STR = {
  es: {
    ...
    chainWrongNetwork: 'Lace está en {network}. Cambia la cartera a {expected}: el contrato compartido vive ahí.',
    chainContractBlurb: 'Scorecard compartido de Preview. Deja esta dirección salvo que un juez te haya dado otra.',
    ...
    midnightSection: 'Midnight', connectWallet: 'Conectar cartera', disconnectWallet: 'Desconectar cartera', viewActivity: 'Ver actividad on-chain',
    walletConnected: 'Conectado: {name}', walletDisconnected: 'Cartera desconectada.', walletNotFound: 'No se ha encontrado ninguna cartera Midnight.',
    walletMockMode: 'Modo simulado (sin cartera conectada)',
    walletConnecting: 'Conectando Lace…',
    walletConnectingApprove: 'Acepta la conexión en Lace…',
    walletConnectingSync: 'Esperando direcciones de Lace (Preview debe estar sincronizado)…',
    walletConnectingWorker: 'Montando los proveedores de Midnight…',
  ...
  en: {
    ...
    chainWrongNetwork: 'Lace is on {network}. Switch the wallet to {expected} — the shared contract lives there.',
    chainContractBlurb: 'Shared Preview Scorecard. Leave this address as-is unless a judge gave you another one.',
    ...
    midnightSection: 'Midnight', connectWallet: 'Connect Wallet', disconnectWallet: 'Disconnect Wallet', viewActivity: 'View On-Chain Activity',
    walletConnected: 'Connected: {name}', walletDisconnected: 'Wallet disconnected.', walletNotFound: 'No Midnight wallet extension found.',
    walletMockMode: 'Mock mode (no wallet connected)',
    walletConnecting: 'Connecting Lace…',
    walletConnectingApprove: 'Approve the connect prompt in Lace…',
    walletConnectingSync: 'Waiting for Lace addresses (Preview must be synced)…',
    walletConnectingWorker: 'Assembling Midnight providers…',
